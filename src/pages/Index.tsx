...
const saleProducts = mockProducts.filter(p => p.is_on_sale);
  ...
  <Layout>
      ...
      <div className="container py-16 md:py-24 text-primary-foreground relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              to="/category/meats"
              className="inline-flex items-center gap-2 bg-primary-foreground text-primary px-6 py-3 rounded-full font-semibold text-sm hover:bg-primary-foreground/90 transition-colors"
            >
              Shop Now <ArrowRight className="w-4 h-4" />
            </Link>
            <Link
              to="/flyer"
              className="inline-flex items-center gap-2 border border-primary-foreground/40 text-primary-foreground px-6 py-3 rounded-full font-semibold text-sm hover:bg-primary-foreground/10 transition-colors"
            >
              Weekly Deals
            </Link>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {features.map((f, i) => (
          <motion.div
            ...
            className="bg-card rounded-lg p-5 flex items-center gap-4 border"
    ...
    {saleProducts.length > 0 && (
      <section className="container mt-16">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link to="/flyer" className="text-sm text-primary font-medium hover:underline flex items-center gap-1">
    ...
    <section className="container mt-16">
      <div className="rounded-2xl p-8 md:p-12 text-center" style={{ background: 'var(--hero-gradient)' }}>
        ...
        <a href="tel:5192082025" className="inline-flex items-center gap-2 bg-primary-foreground text-primary px-6 py-3 rounded-full font-semibold text-sm">
          Call 519-208-2025
        </a>
      </div>
    </section>
